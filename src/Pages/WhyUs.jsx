  ...
  return (
    <section className="why-us">
      <div className="why-us-container">
        <h1 className="why-us-main-title">Why Us</h1>
        <p className="why-us-subtitle">
          <strong>Why Choose Philomath Networks?</strong>
        </p>
        <p className="why-us-text">
          At Philomath Networks Pvt. Ltd., we believe learning goes beyond
          textbooks and traditional classrooms. We specialize in curating
          experiential learning opportunities that engage, inspire, and
          transform individuals across all age groups ranging from school
        ...
        <p className="why-us-text">
          Collaborate with Philomath Networks to bring innovation, engagement,
          and excellence to your institution or organization. Let’s work
          together to create an ecosystem of lifelong learning and impactful
          experiences!
        </p>
      </div>
      <Popup />
